...
import { ClassesDialogComponent } from './Classes_Dialog/Classes-dialog.component';
...
export class ClassesComponent implements OnInit {
  ...
  dataSource: MatTableDataSource<IClasses>=new MatTableDataSource();
  isGridDataLoading : boolean;

  displayedColumns: string[] = ['ClassID','Code' ,'Name', 'Comments','isActive','Action'];
  formSecurity:IFormSecurity;
   

  constructor(
    private _httpClient: HttpClient, public dialog: MatDialog,private _router: Router
    ,private notification : NotificationService, private classService : ClassesService) { }

ngOnInit(): void {
    
  
    this.classService.getFormSeucirty('spClasses')
        .subscribe(data => {
...
refreshGrid(): void{
 ...
 insertRecord(): void{
  debugger;
    this.classService.getFormSeucirty('spClasses').subscribe(data=>{
