...
import { ShiftDialogComponent } from './Shifts_Dialog/shift-dialog.component';
...
export class ShiftsComponent implements OnInit {
  ...
  dataSource: MatTableDataSource<IPayShifts>=new MatTableDataSource();
  isGridDataLoading : boolean;

  displayedColumns: string[] = ['Code' ,'Name', 'Start1','End1','Relaxation','Duration','NextDay','Action'];
  formSecurity:IFormSecurity;
   

  constructor(
    private _httpClient: HttpClient, public dialog: MatDialog,private _router: Router
    ,private notification : NotificationService, private classService : ShiftsService) { }
