...
import { VaccinationsDialogComponent } from './Vaccinations_Dialog/Vaccinations-dialog.component';
...
export class VaccinationsComponent implements OnInit {
  ...
  dataSource: MatTableDataSource<IVaccinations>=new MatTableDataSource();
  ...
  constructor(
    ...
    ,private notification : NotificationService, private classService : VaccinationsService) { }

ngOnInit(): void {
    
  
    this.classService.getFormSeucirty('spDiseases')
        .subscribe(data => {
...
refreshGrid(): void{
    ...
    this.classService.getVaccinations()
            .subscribe(data1 => {
 ...
 insertRecord(): void{
  debugger;
    this.classService.getFormSeucirty('spDiseases').subscribe(data=>{
...
editRecord(obj: IVaccinations): void {
...
deleteRecord(obj: IVaccinations){
  debugger;
  this.selectedRowId = obj.Code;
